...
from data.mpchat_gpp import MpchatClipClipGppDataset, MpchatClipSbertGppDataset
from models.gpp_models import ClipClipGpp, ClipSbertGpp
from modules.checkpoint import load_checkpoint_args
from modules.train_gpp import train, evaluate
...
MODEL_CLASSES = {
    'clip-clip': (ClipClipGpp, MpchatClipClipGppDataset),
    'clip-sbert': (ClipSbertGpp, MpchatClipSbertGppDataset),
}
...
def main():
    ...
    parser.add_argument("--use_response", action='store_true', help="Whether to use response or not for gpp task")
    ...
    parser.add_argument("--max_num_personas", type=int, default=4, help="maximum number of multimodal personas")
    parser.add_argument("--max_num_candidate_persona_elements", type=int, default=100, help="maximum number of multimodal personas")
    parser.add_argument("--max_seq_length", type=int, default=77)
    parser.add_argument("--max_num_imgs", type=int, default=4)
